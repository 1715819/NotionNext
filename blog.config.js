...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'd7ab0980a9e049ba82a1b9ac37f4411e', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 闽ICP备', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/1715819',
  CONTACT_TELEGRAM: '',
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || '藏雪,BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
